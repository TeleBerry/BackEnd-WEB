...
<?php
    ...
    try
    {
		...
		echo "<div class='container'>    
            ...
            print "<tr><td>機櫃編號</td><td>設備編號</td><td>設備相關問題</td><td>設備照片</td><td>更新作業</td></tr>";
            for ($i=0; $i<count($recordRow); $i++)
            {
                ...
                //-----------------------------------------------------------------------
                print "<form action='targetRecordUpdatem.php' method='GET'>";
                print "<input type='hidden' name='updatecabnum' value='".$recordRow[$i]["cabnum"]."'>";
                print "<input type='hidden' name='updatemanum' value='".$recordRow[$i]["manum"]."'>";
                print "<input type='hidden' name='updatemaprob' value='".$recordRow[$i]["maprob"]."'>";
