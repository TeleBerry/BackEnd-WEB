...
<?php
    ...
    else if (!strcmp($queryField, "gmail"))
    {
        $searchField = "gmail";
    }
    else
    ...
    try
    {
		...
		echo "<div class='container'>    
            ...
            print "<tr><td>維修人員編號</td><td>姓名</td><td>電子郵件</td><td>備註</td><td>更新作業</td></tr>";
            for ($i=0; $i<count($recordRow); $i++)
            {
                ...
                //-----------------------------------------------------------------------
                print "<form action='targetRecordUpdatep.php' method='GET'>";
                print "<input type='hidden' name='updateId' value='".$recordRow[$i]["renum"]."'>";
                print "<input type='hidden' name='updateName' value='".$recordRow[$i]["name"]."'>";
                print "<input type='hidden' name='updateemail' value='".$recordRow[$i]["email"]."'>";
                print "<input type='hidden' name='updateremark' value='".$recordRow[$i]["remark"]."'>";
